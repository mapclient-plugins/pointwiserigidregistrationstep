...
#
# Created: Tue Aug 30 23:50:41 2016
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.doubleSpinBox_rotx = QtGui.QDoubleSpinBox(self.widget1)
        self.doubleSpinBox_rotx.setMinimum(-360.0)
        self.doubleSpinBox_rotx.setMaximum(360.0)
        self.doubleSpinBox_rotx.setObjectName("doubleSpinBox_rotx")
        self.initRotLayout.addWidget(self.doubleSpinBox_rotx)
        self.doubleSpinBox_roty = QtGui.QDoubleSpinBox(self.widget1)
        self.doubleSpinBox_roty.setMinimum(-360.0)
        self.doubleSpinBox_roty.setMaximum(360.0)
        self.doubleSpinBox_roty.setObjectName("doubleSpinBox_roty")
        self.initRotLayout.addWidget(self.doubleSpinBox_roty)
        self.doubleSpinBox_rotz = QtGui.QDoubleSpinBox(self.widget1)
        self.doubleSpinBox_rotz.setMinimum(-360.0)
        self.doubleSpinBox_rotz.setMaximum(360.0)
        ...
        self.doubleSpinBox_tx = QtGui.QDoubleSpinBox(self.widget1)
        self.doubleSpinBox_tx.setMinimum(-100000.0)
        self.doubleSpinBox_tx.setMaximum(100000.0)
        self.doubleSpinBox_tx.setSingleStep(1.0)
        self.doubleSpinBox_tx.setObjectName("doubleSpinBox_tx")
        self.initTransLayout.addWidget(self.doubleSpinBox_tx)
        self.doubleSpinBox_ty = QtGui.QDoubleSpinBox(self.widget1)
        self.doubleSpinBox_ty.setMinimum(-100000.0)
        self.doubleSpinBox_ty.setMaximum(100000.0)
        self.doubleSpinBox_ty.setObjectName("doubleSpinBox_ty")
        self.initTransLayout.addWidget(self.doubleSpinBox_ty)
        self.doubleSpinBox_tz = QtGui.QDoubleSpinBox(self.widget1)
        self.doubleSpinBox_tz.setMinimum(-100000.0)
        self.doubleSpinBox_tz.setMaximum(100000.0)
        self.doubleSpinBox_tz.setObjectName("doubleSpinBox_tz")
        ...
        self.doubleSpinBox_scale = QtGui.QDoubleSpinBox(self.widget1)
        self.doubleSpinBox_scale.setMinimum(-100000.0)
        self.doubleSpinBox_scale.setMaximum(100000.0)
        self.doubleSpinBox_scale.setSingleStep(0.05)
        self.doubleSpinBox_scale.setProperty("value", 1.0)
        self.doubleSpinBox_scale.setObjectName("doubleSpinBox_scale")
        self.formLayout_2.setWidget(5, QtGui.QFormLayout.FieldRole, self.doubleSpinBox_scale)
        ...
        Dialog.setTabOrder(self.samplesLineEdit, self.registerButton)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(QtGui.QApplication.translate("Dialog", "Reg. Method:", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_4.setText(QtGui.QApplication.translate("Dialog", "Translations.:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_5.setText(QtGui.QApplication.translate("Dialog", "Rotations:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_6.setText(QtGui.QApplication.translate("Dialog", "Scaling:", None, QtGui.QApplication.UnicodeUTF8))
